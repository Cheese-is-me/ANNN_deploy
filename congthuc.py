...
# Tính thử chỉ số 1
ket_qua_1 = calc.calculate_idx_1(Q_tb=15.5, F=250)
print(f"Kết quả Chỉ số 1: {ket_qua_1}")

# Tính thử chỉ số 16
ket_qua_16 = calc.calculate_idx_16(P_xl=8500, P=10000)
print(f"Kết quả Chỉ số 16: {ket_qua_16}%")